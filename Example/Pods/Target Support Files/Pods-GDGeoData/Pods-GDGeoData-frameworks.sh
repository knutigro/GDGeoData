...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-GDGeoData/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework 'GDGeoData.framework'
  install_framework 'OCHamcrest.framework'
  install_framework 'OCMockito.framework'
