...
// GDGeoData
#define COCOAPODS_POD_AVAILABLE_GDGeoData
#define COCOAPODS_VERSION_MAJOR_GDGeoData 0
#define COCOAPODS_VERSION_MINOR_GDGeoData 1
#define COCOAPODS_VERSION_PATCH_GDGeoData 0
